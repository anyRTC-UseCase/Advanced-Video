...
- (void)initializeRtcKit {
    ...
    //加入频道
    [self.rtcKit joinChannelByToken:nil channelId:@"909090" uid:nil joinSuccess:^(NSString * _Nonnull channel, NSString * _Nonnull uid, NSInteger elapsed) {
        NSLog(@"joinSuccess");
    }];
